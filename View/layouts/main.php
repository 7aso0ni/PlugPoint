        ...
        <div class="container mx-auto flex h-16 items-center justify-between">
            ...
            <?php if (!empty($_COOKIE['loggedIn'])): ?>
                ...
                <nav class="hidden md:flex items-center gap-6">
                    <a href="index.php?route=chargepoints" class="text-sm font-medium hover:text-green-600">Browse
                        Chargers</a>
            ...
            <?php else: ?>
                ...
                <div class="flex items-center gap-4">
                    <a href="index.php?route=login" class="border border-green-600 py-2 px-4 rounded-lg hidden md:block">Log
                        in</a>
